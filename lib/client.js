window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      "  width: 100% !important;",
      "}",
      "/* The main frosted bubble for the tool call item */",
      "html[data-dsh-overlay=\"true\"] [data-chat-flow-kind=\"tool-call\"] [class*=\"callRow\"],",
      "html[data-dsh-overlay=\"true\"] [data-chat-flow-kind=\"tool-call\"] [class*=\"_callRow\"],",
      "html[data-dsh-overlay=\"true\"] [data-chat-flow-kind=\"tool-call\"] [class*=\"o3BgMG_root\"],",
      "html[data-dsh-overlay=\"true\"] [data-chat-flow-kind=\"tool-call\"] [class*=\"CY-8Ka_card\"] {",
      ...
      "  box-sizing: border-box !important;",
      "}",
      "/* Remove nested duplicate background on inner details */",
      "html[data-dsh-overlay=\"true\"] [data-chat-flow-kind=\"tool-call\"] [class*=\"_bodyWrap\"],",
      "html[data-dsh-overlay=\"true\"] [data-chat-flow-kind=\"tool-call\"] [class*=\"_bodyScroll\"] {",
      "  background: transparent !important;",
      "  border: none !important;",
