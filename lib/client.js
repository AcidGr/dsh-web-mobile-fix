    ...
    function apply(ctx) {
      ...
      if (isOverlayMode) {
        ...
        HTMLElement.prototype.focus = function (opts) {
          // If this is an input/textarea/contenteditable and it wasn't triggered by direct user touch, suppress focus
          var isInputLike = this.matches && this.matches('input, textarea, [contenteditable="true"], [role="textbox"], [data-lexical-editor]');
          if (isInputLike && !userInteractedRecently) {
            return;
          }
