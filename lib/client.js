window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      "  box-sizing: border-box !important;",
      "}",
      "/* Filter out empty / hollow bubbles: hide assistant-step if its body has no visible text or content elements */",
      "html[data-dsh-overlay=\"true\"] [data-chat-flow-kind=\"assistant-step\"]:not(:has([class*=\"_body\"] :is(p, pre, ul, ol, table, h1, h2, h3, h4, h5, h6, [data-variant=\"think\"]:not([hidden])))) {",
      "  display: none !important;",
      "}",
      "/* Also hide if body's think block itself is hidden inside turn-process and there is no other text */",
      "html[data-dsh-overlay=\"true\"] [data-chat-flow-kind=\"assistant-step\"]:has([data-turn-process-inline][hidden]):not(:has([class*=\"_body\"] :is(p, pre, ul, ol, table, h1, h2, h3, h4, h5, h6))) {",
      "  display: none !important;",
      "}",
      ...
      "html[data-dsh-overlay=\"true\"] [data-chat-flow-kind=\"assistant-step\"] [class*=\"_root\"]:has(> [class*=\"_body\"] > div > [data-variant=\"think\"]:only-child) {",
      "  background: transparent !important;",
      ...
      "  color: #D1D5DB !important;",
      "  padding: 8px 4px 4px 18px !important;",
      "  font-size: 12.5px !important;",
