window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      "  box-sizing: border-box !important;",
      "}",
      "/* Filter out empty / hollow bubbles (e.g. body has only hidden elements or is empty) */",
      "html[data-dsh-overlay=\"true\"] [data-chat-flow-kind=\"assistant-step\"]:has([class*=\"_body\"] > [hidden]:only-child),",
      "html[data-dsh-overlay=\"true\"] [data-chat-flow-kind=\"assistant-step\"]:has([class*=\"_body\"]:empty) {",
      "  display: none !important;",
      "}",
