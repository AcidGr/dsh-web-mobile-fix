window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      "  width: 100% !important;",
      "}",
      "/* Scope background ONLY to the outermost ToolRow container (never to inner diff/terminal/card) */",
      "html[data-dsh-overlay=\"true\"] [data-chat-flow-kind=\"tool-call\"] > [data-slot] > [class*=\"_root\"],",
      "html[data-dsh-overlay=\"true\"] [data-chat-flow-kind=\"tool-call\"] > [class*=\"_root\"] {",
      ...
      "  overflow: hidden !important;",
      "}",
      "/* Eliminate nested bubble styling inside tool cards */",
      "html[data-dsh-overlay=\"true\"] [data-chat-flow-kind=\"tool-call\"] [class*=\"_bodyWrap\"] [class*=\"_root\"],",
      "html[data-dsh-overlay=\"true\"] [data-chat-flow-kind=\"tool-call\"] [class*=\"_ioCard\"],",
      "html[data-dsh-overlay=\"true\"] [data-chat-flow-kind=\"tool-call\"] [class*=\"_card\"] {",
