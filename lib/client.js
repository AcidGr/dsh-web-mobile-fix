window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      "  pointer-events: none !important;",
      "}",
      "/* When Trajectory View is visible, automatically show the Back-to-Chat button! */",
    ...
    function apply(ctx) {
      ...
      var onOverlayClick = function (event) {
        ...
        // Step A2: If currently inside Trajectory view, clicking blank returns to Chat!
        var isTrajectory = !!document.querySelector('[data-trajectory-scroll], [data-conversation-composer-overlay]');
        if (isTrajectory) {
