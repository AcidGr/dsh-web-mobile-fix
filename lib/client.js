window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      "  }",
      "  [class*=\"_frame\"] [class*=\"_sidebarCol\"] > div {",
      "    position: relative !important;",
      "    z-index: 61 !important;",
      "    transition: box-shadow 0.2s ease !important;",
      "  }",
      "  [class*=\"_frame\"][data-sidebar-collapsed] [class*=\"_sidebarCol\"] > div {",
      "    box-shadow: none !important;",
      "  }",
      "  [class*=\"_frame\"]:not([data-sidebar-collapsed]) [class*=\"_sidebarCol\"] > div {",
      "    box-shadow: 4px 0 24px rgba(0, 0, 0, 0.22) !important;",
      "    animation: dsh-drawer-slide-in 0.24s cubic-bezier(0.16, 1, 0.3, 1) !important;",
      "  }",
      "  [class*=\"_frame\"] [class*=\"_centerCol\"] {",
      "    position: relative !important;",
      "  }",
      "  [class*=\"_frame\"] [class*=\"_centerCol\"]::before {",
      "    content: \"\" !important;",
      ...
      "  }",
      "  [class*=\"_frame\"][data-sidebar-collapsed] [class*=\"_centerCol\"]::before {",
      "    opacity: 0 !important;",
      "    visibility: hidden !important;",
      "    pointer-events: none !important;",
      "    transition: opacity 0.2s ease-in, visibility 0.2s !important;",
      "  }",
      ...
      "    transition: opacity 0.24s ease-out, visibility 0s !important;",
      "  }",
      "}",
      "",
      ...
      "  width: 0 !important;",
      "}",
      "/* Overlay Sidebar Drawer: shared base */",
      "html[data-dsh-overlay=\"true\"] [class*=\"_frame\"]:has(> [class*=\"_sidebarCol\"]) [class*=\"_sidebarCol\"] {",
      ...
      "  box-sizing: border-box !important;",
      "}",
      "/* Collapsed drawer in overlay: smoothly slide out to left */",
      "html[data-dsh-overlay=\"true\"] [class*=\"_frame\"]:has(> [class*=\"_sidebarCol\"])[data-sidebar-collapsed] [class*=\"_sidebarCol\"] {",
      "  left: -320px !important;",
      "  opacity: 0 !important;",
      "  visibility: hidden !important;",
      "  pointer-events: none !important;",
      "  transition: left 0.22s cubic-bezier(0.4, 0, 1, 1), opacity 0.2s ease-in, visibility 0.22s !important;",
      "}",
      "/* Expanded drawer in overlay: smoothly slide in from left */",
      "html[data-dsh-overlay=\"true\"] [class*=\"_frame\"]:has(> [class*=\"_sidebarCol\"]):not([data-sidebar-collapsed]) [class*=\"_sidebarCol\"] {",
      "  left: 0 !important;",
      "  opacity: 1 !important;",
      "  visibility: visible !important;",
      "  pointer-events: auto !important;",
      "  transition: left 0.25s cubic-bezier(0.16, 1, 0.3, 1), opacity 0.2s ease-out, visibility 0s !important;",
      "}",
      "/* Overlay Backdrop: shared base */",
      "html[data-dsh-overlay=\"true\"] [class*=\"_frame\"]:has(> [class*=\"_sidebarCol\"])::after {",
      "  content: \"\" !important;",
      "  position: fixed !important;",
      "  inset: 0 !important;",
      ...
      "}",
      "/* Collapsed backdrop in overlay: fade out */",
      "html[data-dsh-overlay=\"true\"] [class*=\"_frame\"]:has(> [class*=\"_sidebarCol\"])[data-sidebar-collapsed]::after {",
      "  opacity: 0 !important;",
      "  visibility: hidden !important;",
      "  pointer-events: none !important;",
      "  transition: opacity 0.2s ease-in, visibility 0.2s !important;",
      "}",
      "/* Expanded backdrop in overlay: fade in */",
      ...
      "}",
      "/* Plugin Manager Page in Overlay Mode: frosted dark surface */",
      "html[data-dsh-overlay=\"true\"] [data-plugin-panel],",
      "html[data-dsh-overlay=\"true\"] section[class*=\"_page\"]:has([class*=\"_pageHead\"]),",
      "html[data-dsh-overlay=\"true\"] section[class*=\"_page\"]:has([class*=\"_cards\"]) {",
      ...
      "  overflow-y: auto !important;",
      "}",
      "html[data-dsh-overlay=\"true\"] [data-plugin-panel] [class*=\"_card\"],",
      "html[data-dsh-overlay=\"true\"] [data-plugin-panel] [class*=\"_detail\"] {",
      ...
      "  color: #F0F2F5 !important;",
      "}",
      "html[data-dsh-overlay=\"true\"] [data-plugin-panel] [class*=\"_card\"]:active,",
      "html[data-dsh-overlay=\"true\"] [data-plugin-panel] [class*=\"_cardLink\"]:active {",
      "  background: rgba(42, 48, 62, 0.96) !important;",
      "}",
      "html[data-dsh-overlay=\"true\"] [data-plugin-panel] [class*=\"_pageTitle\"],",
      "html[data-dsh-overlay=\"true\"] [data-plugin-panel] [class*=\"_groupTitle\"],",
      "html[data-dsh-overlay=\"true\"] [data-plugin-panel] [class*=\"_cardTitle\"],",
      "html[data-dsh-overlay=\"true\"] [data-plugin-panel] [class*=\"_detailTitle\"] {",
      "  color: #FFFFFF !important;",
      "}",
      "html[data-dsh-overlay=\"true\"] [data-plugin-panel] [class*=\"_pageIntro\"],",
      "html[data-dsh-overlay=\"true\"] [data-plugin-panel] [class*=\"_cardDesc\"],",
      "html[data-dsh-overlay=\"true\"] [data-plugin-panel] [class*=\"_detailDesc\"],",
      "html[data-dsh-overlay=\"true\"] [data-plugin-panel] [class*=\"_detailName\"] {",
      "  color: #9CA3AF !important;",
      "}",
      "html[data-dsh-overlay=\"true\"] [data-plugin-panel] [class*=\"_row\"] {",
      ...
      "}",
      "html[data-dsh-overlay=\"true\"] [data-plugin-panel] button[class*=\"_addButton\"],",
      "html[data-dsh-overlay=\"true\"] [data-plugin-panel] button[class*=\"_iconButton\"] {",
    ...
    function apply(ctx) {
      ...
      if (isOverlayMode) {
        ...
        var collapseSidebarIfOpen = function () {
          try {
        ...
        homeBtn.addEventListener("click", function (e) {
          ...
          // 3. Collapse sidebar drawer if expanded
          collapseSidebarIfOpen();

          // 4. Return from Trajectory or other tabs back to Chat view
          switchToChat();
            ...
            for (var i = 0; i < mutations.length; i++) {
              ...
              for (var j = 0; j < removed.length; j++) {
                ...
                if (node instanceof Element) {
                  if (node.matches && node.matches('[role="menu"], [role="listbox"], [role="dialog"], [role="alertdialog"], [data-dockkit-tab-menu], [data-floating-ui-portal], [class*="menu"], [class*="Menu"], [class*="dsh-cabinet"]')) {
                    lastPopupDismissTime = Date.now();
                    return;
                  }
                  if (node.querySelector && node.querySelector('[role="menu"], [role="listbox"], [role="dialog"], [role="alertdialog"], [class*="dsh-cabinet"]')) {
                    lastPopupDismissTime = Date.now();
                    return;
                  }
                }
      ...
      var onTouchOrPointerDown = function (e) {
        ...
        var isNarrowScreen = typeof window !== "undefined" && window.innerWidth <= 700;
        if (!isOverlay && !isNarrowScreen) return;
        var activePopup = document.querySelector(
          '[role="menu"], [role="listbox"], [role="dialog"], [role="alertdialog"], ' +
          '[data-dockkit-tab-menu], [data-floating-ui-portal] > *, [class*="Menu_menu"], [class*="dsh-cabinet-backdrop"]'
        );
        var target = e.target instanceof Element ? e.target : (e.target && e.target.parentElement);
      ...
      var onOverlayClick = function (event) {
        ...
        // Level 1: Floating top control buttons (overlay mode)
        ...
        // Special Level: Settings Dialog Dismissal (both mobile narrow screen and overlay)
        var settingsDialog = document.querySelector('[role="dialog"][aria-modal="true"][aria-labelledby]');
        if (settingsDialog) {
          if (settingsDialog.contains(target)) {
            // Check if clicked an interactive control or setting item row
            var isSettingInteractive = target.closest && target.closest(
              'button, input, select, textarea, label, a, [role="button"], [role="switch"], [role="tab"], [role="option"], [role="checkbox"], ' +
              '[data-slot*="settings."], [class*="row"], [class*="Row"], [class*="card"], [class*="Card"], [class*="field"], [class*="Field"], [class*="cell"], [class*="Cell"], nav'
            );
            if (!isSettingInteractive) {
              // Clicked on the blank/empty area of settings panel!
              event.preventDefault();
              event.stopPropagation();
              var closeBtn = settingsDialog.querySelector('button[class*="close"], button[aria-label*="close" i], button[aria-label*="关闭"], [class*="_close"]');
              if (closeBtn) {
                closeBtn.click();
              } else {
            ...
            return; // Interactive settings element clicked -> let it work normally
          } else {
            // Clicked OUTSIDE settings dialog (e.g. on backdrop mask)
            event.preventDefault();
            event.stopPropagation();
            var closeBtnOutside = settingsDialog.querySelector('button[class*="close"], button[aria-label*="close" i], button[aria-label*="关闭"], [class*="_close"]');
            if (closeBtnOutside) {
              closeBtnOutside.click();
            } else {
              document.dispatchEvent(new KeyboardEvent("keydown", { key: "Escape", code: "Escape", bubbles: true, cancelable: true }));
            }
            return;
        ...
        if (target.closest && target.closest(
          ...
          '[data-disclosure-row], [data-variant="think"], [class*="lcKema"], ' +
          '[data-step-process], [data-step-process-body], ' +
          '[data-plugin-panel], [data-plugin-panel] *, ' +
          '[class*="dsh-pet"], [class*="dsh-cabinet-wrapper"], [class*="dsh-cabinet-box"], ' +
        ...
        // Level 4: Is the Sidebar Drawer currently expanded? (Works on both narrow screen and overlay)
        var frame = document.querySelector('[class*="_frame"]:has(> [class*="_sidebarCol"])') ||
                    (document.querySelector('[data-slot="root"] [class*="_sidebarCol"]') ? document.querySelector('[data-slot="root"] [class*="_sidebarCol"]').parentElement : null);
        ...
        if (isSidebarOpen && sidebarCol) {
          // If clicking a panel item in the sidebar (e.g. Plugins), auto-collapse the sidebar drawer so the panel is revealed
          if (target.closest && target.closest('[class*="panelRow"], button[aria-label*="插件"], button[aria-label*="Plugin" i]')) {
            setTimeout(function () {
              collapseSidebarIfOpen();
            }, 80);
            return;
        ...
        // If NOT in overlay mode, stop here (regular browser clicks on chat blank space shouldn't press back)
        if (!isOverlay) return;

        // Level 5: Grand Unified Back Action ("Click Blank = Press Back")
        // Step A: If soft keyboard is currently open, first click on blank ONLY closes keyboard!
        var isKbOpen = false;
        try {
          if (window.DSHOverlayBridge && typeof window.DSHOverlayBridge.isKeyboardShowing === "function") {
            isKbOpen = window.DSHOverlayBridge.isKeyboardShowing();
          }
        } catch (e) {}

        var activeEl = document.activeElement;
        var isInputFocused = activeEl && (
          activeEl.matches && activeEl.matches('input, textarea, [contenteditable="true"], [role="textbox"], [data-lexical-editor]') ||
          (activeEl.tagName === 'INPUT' || activeEl.tagName === 'TEXTAREA')
        );

        if (isKbOpen || isInputFocused) {
          try {
          ...
          return; // Soft keyboard dismissed! App stays in foreground!
        }

        // Step A2: If currently inside Trajectory view or Plugin Manager, clicking blank returns to Chat!
        var isSubView = !!document.querySelector('[data-trajectory-scroll], [data-conversation-composer-overlay], [data-plugin-panel]');
        if (isSubView) {
          if (switchToChat()) return;
        }

        // Step B: If no keyboard is showing, clicking on transparent blank minimizes app via pressBack()
        try {
