  ...
  factory: (require) => {
    ...
    function apply(ctx) {
      ...
      var onOverlayClick = function (event) {
        ...
        // Step 1: If soft keyboard is currently open or input focused, first click on blank ONLY closes keyboard!
        var isKbOpen = false;
        try {
        ...
        // Step 2: If currently inside Trajectory view or Plugin Manager, clicking blank returns to Chat!
        ...
        // Step 3: Pure blank tap -> minimize app / pressBack to reveal Android home/host app
        try {
